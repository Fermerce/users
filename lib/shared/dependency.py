...
from lib.exceptions.forbidden_error import ForbiddenError
from lib.exceptions.denied_access_error import AccessDenied
...
ModelType = t.TypeVar("ModelType", bound=model.BaseModel)


class AppWrite(t.Generic[ModelType]):
    def __init__(self, model: ModelType, model_query: BaseQuery) -> None:
        self.model = model
