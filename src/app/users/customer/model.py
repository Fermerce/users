...
class Customer(model.BaseModel):
    ...
    password: t.Optional[str] = ormar.String(max_length=300)
    password_reset_token: t.Optional[str] = ormar.String(nullable=True, max_length=300)
    is_verified: bool = ormar.Boolean(default=False)
    is_suspended: bool = ormar.Boolean(default=False)
    is_active: bool = ormar.Boolean(default=True)
    permissions: t.Optional[t.List[Permission]] = ormar.ManyToMany(Permission)
