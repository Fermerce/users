...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['customer'], ['customers.id'], name='fk_customer_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['permission'], ['permission.id'], name='fk_permission_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['details'], ['product_detail.id'], name='fk_product_details'),
    sa.ForeignKeyConstraint(['medias'], ['product_media.id'], name='fk_product_medias'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['permission'], ['permission.id'], name='fk_permission_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['staff'], ['staff.id'], name='fk_staff_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['product'], ['product.id'], name='fk_products_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['productcategory'], ['p_category.id'], name='fk_products_category_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('product', ormar.fields.sqlalchemy_uuid.CHAR(36), nullable=True),
    sa.ForeignKeyConstraint(['product'], ['product.id'], name='fk_products_munit_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['productmeasuringunit'], ['product_measuring_unit.id'], name='fk_meunit__id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['productpromocode'], ['p_promocode.id'], name='fk_products_productpromocode_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
