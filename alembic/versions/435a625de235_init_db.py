...
Revision ID: 435a625de235
Revises: 
Create Date: 2023-04-06 18:56:49.267523
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["medias"], ["p_media.id"], name="fk_product_p_media_id_medias"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["productcategory"],
            ["p_category.id"],
            name="fk_products_productcategorys_p_category_productcategory_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["p_m_unit.id"],
            name="fk_products_productmeasuringunits_p_m_unit_productmeasuringunit_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["productpromocode"],
            ["p_promocode.id"],
            name="fk_products_productpromocodes_p_promocode_productpromocode_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    op.drop_table("p_media")
    op.drop_table("p_m_unit")
